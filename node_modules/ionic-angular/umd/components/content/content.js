...
(function (factory) {
    ...
    var Content = (function (_super) {
        ...
        function Content(config, _plt, _dom, elementRef, renderer, _app, _keyboard, _zone, viewCtrl, navCtrl) {
            ...
            var enableScrollListener = _this.enableScrollListener.bind(_this);
            ...
            var jsScroll = config.getBoolean('virtualScrollEventAssist');
            _this._scroll = new scroll_view_1.ScrollView(_app, _plt, _dom, jsScroll);
            while (navCtrl) {
         ...
         * @return {?}
         */
        Content.prototype.enableScrollListener = function () {
