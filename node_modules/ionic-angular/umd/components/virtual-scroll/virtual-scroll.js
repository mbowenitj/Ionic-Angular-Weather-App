    ...
    var VirtualScroll = (function () {
        ...
        VirtualScroll.prototype.renderVirtual = function (needClean) {
            ...
            this._plt.raf(function () {
                ...
                virtual_util_1.populateNodeData(data.topCell, data.bottomCell, data.viewWidth, true, cells, records, nodes, _this._itmTmp.viewContainer, _this._itmTmp.templateRef, _this._hdrTmp && _this._hdrTmp.templateRef, _this._ftrTmp && _this._ftrTmp.templateRef, needClean);
                if (needClean) {
        ...
        VirtualScroll.prototype._stepNoChanges = function () {
            ...
            virtual_util_1.adjustRendered(cells, data);
            var /** @type {?} */ hasChanges = virtual_util_1.populateNodeData(data.topCell, data.bottomCell, data.viewWidth, diff > 0, cells, records, nodes, this._itmTmp.viewContainer, this._itmTmp.templateRef, this._hdrTmp && this._hdrTmp.templateRef, this._ftrTmp && this._ftrTmp.templateRef, false);
            if (hasChanges) {
