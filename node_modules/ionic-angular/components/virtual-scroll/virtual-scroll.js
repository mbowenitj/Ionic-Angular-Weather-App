...
var VirtualScroll = (function () {
    ...
    VirtualScroll.prototype.renderVirtual = function (needClean) {
        ...
        this._plt.raf(function () {
            ...
            populateNodeData(data.topCell, data.bottomCell, data.viewWidth, true, cells, records, nodes, _this._itmTmp.viewContainer, _this._itmTmp.templateRef, _this._hdrTmp && _this._hdrTmp.templateRef, _this._ftrTmp && _this._ftrTmp.templateRef, needClean);
            if (needClean) {
